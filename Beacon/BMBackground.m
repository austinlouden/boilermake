...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UILabel *table1 = [[UILabel alloc] initWithFrame:CGRectMake(40.0f, 143.0f, 250.0f, 50.0f)];
        table1.text = @"TABLE 1";
        ...
        UILabel *table2 = [[UILabel alloc] initWithFrame:CGRectMake(300.0f, 143.0f, 250.0f, 50.0f)];
        table2.text = @"TABLE 2";
        ...
        UILabel *table3 = [[UILabel alloc] initWithFrame:CGRectMake(560.0f, 143.0f, 250.0f, 50.0f)];
        table3.text = @"TABLE 3";
...
- (void)drawRect:(CGRect)rect
{
 ...
 [drawingPath stroke];
     ...
     //draw some tables
    CGRect rectangle = CGRectMake(40, 143, 250, 50);
    ...
    CGRect rectangle2 = CGRectMake(300, 143, 250, 50);
    ...
    CGRect rectangle3 = CGRectMake(560, 143, 250, 50);
